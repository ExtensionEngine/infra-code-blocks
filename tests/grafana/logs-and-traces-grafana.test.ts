...
export function testLogsAndTracesGrafana(ctx: GrafanaTestContext) {
  ...
  it('should have created the dashboard with expected panels and variables', async () => {
    const grafana = ctx.outputs!.logsAndTracesGrafana;
    ...
    await backOff(async () => {
      ...
      assert.deepStrictEqual(
        ...
        'Dashboard variables do not match expected variables',
      );
    });
  });
